 ...
 <?php require 'partials/footer.php' ?>
  <!-- <main>
    <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      hello welcome with <h2>about</h2>  
    ...
    <div class="h-full">
      ...
      <div class="container pt-24 md:pt-36 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="w-full pt-16 pb-6 text-sm text-center md:text-left fade-in">
          <a class="text-gray-500 no-underline hover:no-underline" href="#">&copy; App 2025</a>
          - coded by
          <a class="text-gray-500 no-underline hover:no-underline" href="https://www.tailwindtoolbox.com">Eng.Mohammed Mogeab Ahmed</a>
        </div>
      </div>
    </div>
  </body>
